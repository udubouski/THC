...
void AudioFlinger::ThreadBase::dumpBase(int fd, const Vector<String16>& args __unused)
{
    ...
    ALOGE("THX mChannelCount : %u ", mChannelCount);
        ...
        audio_port_handle_t portId)
{
    ...
    ALOGE("THX channelMask : %u", channelMask);
    ALOGE("THX mChannelMask : %u", mChannelMask);
    ALOGE("TXH AUDIO_CHANNEL_OUT_STEREO : %u", AUDIO_CHANNEL_OUT_STEREO);
